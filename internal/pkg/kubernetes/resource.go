...
func (c *Client) CreateResourceQuota(ctx context.Context, namespace, name string, cpu, memory string) error {
...
func (c *Client) CreateNetworkPolicy(ctx context.Context, namespace, name string, allowNamespaceLabels map[string]string) error {
